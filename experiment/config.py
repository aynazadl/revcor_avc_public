...
# main parameters
main_pars = {
    'outPath': './temp',   # output root folder
    'numFiles': 400,     # number of output files to generate (for random modifications)
    'chain': True,
...
pitch_pars = {
    ...
    'std': 150,        # standard deviation (cents) for random transposisiton (Gaussian distrib for now)
